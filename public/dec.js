let tour = new Shepherd.Tour({
    ...
    tour.addStep({
      id: 'intro',
      text: `The transparent dates are the dates where some events didnot happen in this calender .`,
      buttons: [
        {
          text: 'Next',
          action: tour.next
    ...
    tour.addStep({
      id: 'december1',
      text: 'Significant oxygen atmosphere begins to develop on Earth.',
      attachTo: {
        element: '.day:nth-child(3)',
        on: 'bottom'
      },
      buttons: [
        {
    ...
    tour.addStep({
      id: 'december5',
      text: 'Extensive vulcanism and channel formation on Mars.',
      attachTo: {
        element: '.day:nth-child(7)',
        on: 'bottom'
      },
      buttons: [
        {
    ...
    tour.addStep({
      id: 'dec14',
      text: 'Sponges emerged.',
      attachTo: {
        element: '.day:nth-child(16)',
        on: 'bottom'
      },
      buttons: [
        {
    ...
    tour.addStep({
      id: 'dec17',
      text: 'First fish appears .',
      attachTo: {
        element: '.day:nth-child(19)',
        on: 'bottom'
      },
      buttons: [
        {
    ...
    tour.addStep({
      id: 'dec20',
      text: 'First Land plants appear .',
      attachTo: {
        element: '.day:nth-child(22)',
        on: 'bottom'
      },
      buttons: [
        {
    ...
    tour.addStep({
      id: 'dec21',
      text: 'First insects appeared .',
      attachTo: {
        element: '.day:nth-child(23)',
        on: 'bottom'
      },
      buttons: [
        {
    ...
    tour.addStep({
      id: 'dec22',
      text: 'First amphibians .',
      attachTo: {
        element: '.day:nth-child(24)',
        on: 'bottom'
      },
      buttons: [
        {
    ...
    tour.addStep({
      id: 'dec23',
      text: 'First reptiles and first trees appeared ',
      attachTo: {
        element: '.day:nth-child(25)',
        on: 'bottom'
      },
      buttons: [
        {
